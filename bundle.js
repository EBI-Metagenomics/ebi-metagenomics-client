		...
		if ( documentIsHTML ) {
			...
			***REMOVED***
			...
			if ( support.qsa &&
				...
				***REMOVED*** else if ( context.nodeName.toLowerCase() !== "object" ) {
			...
			***REMOVED*** else {
				while ( (elem = elem[ dir ]) ) {
					if ( elem.nodeType === 1 || checkNonElements ) {
						...
						// Support: IE <9 only
						// Defend against cloned attroperties (jQuery gh-1709)
						uniqueCache = outerCache[ elem.uniqueID ] || (outerCache[ elem.uniqueID ] = {***REMOVED***);
...
function adoptValue( value, resolve, reject, noValue ) {
	...
	try {
		...
		// Other thenables
		***REMOVED*** else if ( value && jQuery.isFunction( ( method = value.then ) ) ) {
	...
	***REMOVED***,
	...
	dispatch: function( nativeEvent ) {
		...
		var i, j, ret, matched, handleObj, handlerQueue,
			...
			handlers = ( dataPriv.get( this, "events" ) || {***REMOVED*** )[ event.type ] || [],
	...
	trigger: function( event, data, elem, onlyHandlers ) {
		...
		***REMOVED***
		...
		while ( ( cur = eventPath[ i++ ] ) && !event.isPropagationStopped() ) {
			...
			// jQuery handler
			handle = ( dataPriv.get( cur, "events" ) || {***REMOVED*** )[ event.type ] &&
...
if ( true ) {
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function() {
		return jQuery;
	***REMOVED***.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
...
var Studies = _backbone2.default.Collection.extend({
	url: 'http://wp-np2-90:8000/v0.2/studies'
...
studies.fetch({
	success: function success(collection, response, options) {
		(0, _jquery2.default)('#tmp').text(JSON.stringify(response.data));
...
(function(factory) {
  ...
  ***REMOVED*** else if (typeof exports !== 'undefined') {
    ...
    try { $ = require('jquery'); ***REMOVED*** catch (e) {***REMOVED***
    factory(root, exports, _, $);

  // Finally, as a browser global.
  ***REMOVED*** else {
    root.Backbone = factory(root, {***REMOVED***, root._, (root.jQuery || root.Zepto || root.ender || root.$));
  ***REMOVED***

***REMOVED***)(function(root, Backbone, _, $) {
  ...
  ***REMOVED***;
  ...
  //
  // collection.filter(function(model) { return model.get('age') > 10 ***REMOVED***);
  ...
  ***REMOVED***;
  ...
  // Support `collection.sortBy('attr')` and `collection.findWhere({id: 1***REMOVED***)`.
  var cb = function(iteratee, instance) {
    if (_.isFunction(iteratee)) return iteratee;
    if (_.isObject(iteratee) && !instance._isModel(iteratee)) return modelMatcher(iteratee);
    if (_.isString(iteratee)) return function(model) { return model.get(iteratee); ***REMOVED***;
    return iteratee;
  ***REMOVED***;
  ...
  ***REMOVED***;
  ...
  //     object.on('expand', function(){ alert('expanded'); ***REMOVED***);
  //     object.trigger('expand');
  //
  var Events = Backbone.Events = {***REMOVED***;
  ...
  var eventsApi = function(iteratee, events, name, callback, opts) {
    ...
    if (name && typeof name === 'object') {
      ...
      ***REMOVED***
    ***REMOVED*** else if (name && eventSplitter.test(name)) {
  ...
  ***REMOVED***;
  ...
  var internalOn = function(obj, name, callback, context, listening) {
    obj._events = eventsApi(onApi, obj._events || {***REMOVED***, name, callback, {
      context: context,
      ctx: obj,
      listening: listening
    ***REMOVED***);
    ...
    if (listening) {
      var listeners = obj._listeners || (obj._listeners = {***REMOVED***);
  ...
  ***REMOVED***;
  ...
  Events.listenTo = function(obj, name, callback) {
    ...
    var listeningTo = this._listeningTo || (this._listeningTo = {***REMOVED***);
    ...
    if (!listening) {
      ...
      listening = listeningTo[id] = {obj: obj, objId: id, id: thisId, listeningTo: listeningTo, count: 0***REMOVED***;
    ***REMOVED***
  ...
  ***REMOVED***;
  ...
  var onApi = function(events, name, callback, options) {
    if (callback) {
      ...
      handlers.push({callback: callback, context: context, ctx: context || ctx, listening: listening***REMOVED***);
    ***REMOVED***
    return events;
  ***REMOVED***;
  ...
  ***REMOVED***;
  ...
  Events.once = function(name, callback, context) {
    // Map the event into a `{event: once***REMOVED***` object.
    var events = eventsApi(onceMap, {***REMOVED***, name, callback, _.bind(this.off, this));
  ...
  ***REMOVED***;
  ...
  Events.listenToOnce = function(obj, name, callback) {
    // Map the event into a `{event: once***REMOVED***` object.
    var events = eventsApi(onceMap, {***REMOVED***, name, callback, _.bind(this.stopListening, this, obj));
    return this.listenTo(obj, events);
  ***REMOVED***;

  // Reduces the event callbacks into a map of `{event: onceWrapper***REMOVED***`.
  ...
  ***REMOVED***;
  ...
  var Model = Backbone.Model = function(attributes, options) {
    var attrs = attributes || {***REMOVED***;
    options || (options = {***REMOVED***);
    this.cid = _.uniqueId(this.cidPrefix);
    this.attributes = {***REMOVED***;
    if (options.collection) this.collection = options.collection;
    if (options.parse) attrs = this.parse(attrs, options) || {***REMOVED***;
    var defaults = _.result(this, 'defaults');
    attrs = _.defaults(_.extend({***REMOVED***, defaults, attrs), defaults);
  ...
  _.extend(Model.prototype, Events, {
    ...
    ***REMOVED***,
    ...
    set: function(key, val, options) {
      ...
      // Handle both `"key", value` and `{key: value***REMOVED***` -style arguments.
      var attrs;
      if (typeof key === 'object') {
        attrs = key;
        options = val;
      ***REMOVED*** else {
        (attrs = {***REMOVED***)[key] = val;
      ***REMOVED***
    ...
    ***REMOVED***,
    ...
    unset: function(attr, options) {
      return this.set(attr, void 0, _.extend({***REMOVED***, options, {unset: true***REMOVED***));
    ***REMOVED***,
    ...
    clear: function(options) {
      ...
      return this.set(attrs, _.extend({***REMOVED***, options, {unset: true***REMOVED***));
    ***REMOVED***,
    ...
    ***REMOVED***,
    ...
    fetch: function(options) {
      options = _.extend({parse: true***REMOVED***, options);
      var model = this;
    ...
    ***REMOVED***,
    ...
    save: function(key, val, options) {
      ...
      ***REMOVED***
      ...
      options = _.extend({validate: true, parse: true***REMOVED***, options);
      ...
      ***REMOVED*** else if (!this._validate(attrs, options)) {
        return false;
      ***REMOVED***
      ...
      options.success = function(resp) {
        ...
        var serverAttrs = options.parse ? model.parse(resp, options) : resp;
        if (wait) serverAttrs = _.extend({***REMOVED***, attrs, serverAttrs);
      ...
      ***REMOVED***;
      ...
      // Set temporary attributes if `{wait: true***REMOVED***` to properly find new ids.
      if (attrs && wait) this.attributes = _.extend({***REMOVED***, attributes, attrs);
    ...
    ***REMOVED***,
    ...
    destroy: function(options) {
      options = options ? _.clone(options) : {***REMOVED***;
      var model = this;
      var success = options.success;
      var wait = options.wait;
    ...
    ***REMOVED***,
    ...
    isValid: function(options) {
      return this._validate({***REMOVED***, _.extend({***REMOVED***, options, {validate: true***REMOVED***));
    ***REMOVED***,
    ...
    _validate: function(attrs, options) {
      ...
      attrs = _.extend({***REMOVED***, this.attributes, attrs);
      var error = this.validationError = this.validate(attrs, options) || null;
      if (!error) return true;
      this.trigger('invalid', this, error, _.extend(options, {validationError: error***REMOVED***));
      return false;
    ***REMOVED***
  ...
  ***REMOVED***);
  ...
  var modelMethods = {keys: 1, values: 1, pairs: 1, invert: 1, pick: 0,
      omit: 0, chain: 1, isEmpty: 1***REMOVED***;
  ...
  var Collection = Backbone.Collection = function(models, options) {
    ...
    this._reset();
    this.initialize.apply(this, arguments);
    if (models) this.reset(models, _.extend({silent: true***REMOVED***, options));
  ***REMOVED***;

  // Default options for `Collection#set`.
  var setOptions = {add: true, remove: true, merge: true***REMOVED***;
  var addOptions = {add: true, remove: false***REMOVED***;
  ...
  ***REMOVED***;
  ...
  _.extend(Collection.prototype, Events, {
    ...
    // models' attributes.
    toJSON: function(options) {
      return this.map(function(model) { return model.toJSON(options); ***REMOVED***);
    ***REMOVED***,
    ...
    ***REMOVED***,
    ...
    add: function(models, options) {
      return this.set(models, _.extend({merge: false***REMOVED***, options, addOptions));
    ***REMOVED***,

    // Remove a model, or a list of models from the set.
    remove: function(models, options) {
      options = _.extend({***REMOVED***, options);
      var singular = !_.isArray(models);
      models = singular ? [models] : models.slice();
      var removed = this._removeModels(models, options);
      if (!options.silent && removed.length) {
        options.changes = {added: [], merged: [], removed: removed***REMOVED***;
    ...
    ***REMOVED***,
    ...
    set: function(models, options) {
      ...
      options = _.extend({***REMOVED***, setOptions, options);
      ...
      ***REMOVED***
      ...
      if (sort) this.sort({silent: true***REMOVED***);
    ...
    ***REMOVED***,
    ...
    reset: function(models, options) {
      ...
      ***REMOVED***
      ...
      this._reset();
      models = this.add(models, _.extend({silent: true***REMOVED***, options));
    ...
    ***REMOVED***,
    ...
    push: function(model, options) {
      return this.add(model, _.extend({at: this.length***REMOVED***, options));
    ***REMOVED***,
    ...
    ***REMOVED***,
    ...
    unshift: function(model, options) {
      return this.add(model, _.extend({at: 0***REMOVED***, options));
    ***REMOVED***,
  ...
  ***REMOVED***);
  ...
  var collectionMethods = {forEach: 3, each: 3, map: 3, collect: 3, reduce: 0,
      ...
      sortBy: 3, indexBy: 3, findIndex: 3, findLastIndex: 3***REMOVED***;
  ...
  ***REMOVED***;
  ...
  _.extend(View.prototype, Events, {
    ...
    ***REMOVED***,
    ...
    //
    // *{"event selector": "callback"***REMOVED****
    //
    //     {
    //       'mousedown .title':  'edit',
    //       'click .button':     'save',
    //       'click .open':       function(e) { ... ***REMOVED***
    //     ***REMOVED***
    //
    ...
    ***REMOVED***,
    ...
    _ensureElement: function() {
      if (!this.el) {
        var attrs = _.extend({***REMOVED***, _.result(this, 'attributes'));
  ...
  ***REMOVED***);
  ...
  Backbone.sync = function(method, model, options) {
    ...
    _.defaults(options || (options = {***REMOVED***), {
      emulateHTTP: Backbone.emulateHTTP,
      emulateJSON: Backbone.emulateJSON
    ***REMOVED***);

    // Default JSON-request options.
    var params = {type: type, dataType: 'json'***REMOVED***;
    ...
    ***REMOVED***
    ...
    if (options.emulateJSON) {
      ...
      params.data = params.data ? {model: params.data***REMOVED*** : {***REMOVED***;
    ***REMOVED***
  ...
  _.extend(History.prototype, Events, {
    ...
    ***REMOVED***,
    ...
    start: function(options) {
      ...
      this.options          = _.extend({root: '/'***REMOVED***, this.options, options);
      ...
      if (this._wantsHashChange && this._wantsPushState) {
        ...
        ***REMOVED*** else if (this._hasPushState && this.atRoot()) {
          this.navigate(this.getHash(), {replace: true***REMOVED***);
        ***REMOVED***
      ...
      ***REMOVED*** else if (this._useHashChange && !this.iframe) {
        addEventListener('hashchange', this.checkUrl, false);
      ***REMOVED*** else if (this._wantsHashChange) {
    ...
    ***REMOVED***,
    ...
    route: function(route, callback) {
      this.handlers.unshift({route: route, callback: callback***REMOVED***);
    ***REMOVED***,
    ...
    ***REMOVED***,
    ...
    navigate: function(fragment, options) {
      ...
      if (!options || options === true) options = {trigger: !!options***REMOVED***;
      ...
      ***REMOVED***
      ...
      if (this._usePushState) {
        this.history[options.replace ? 'replaceState' : 'pushState']({***REMOVED***, document.title, url);
  ...
  ***REMOVED***);
  ...
  var extend = function(protoProps, staticProps) {
    ...
    ***REMOVED*** else {
      child = function(){ return parent.apply(this, arguments); ***REMOVED***;
    ***REMOVED***
...
/* WEBPACK VAR INJECTION */***REMOVED***.call(exports, __webpack_require__(3)))
...
// easier to handle this case. if(!global) { ...***REMOVED***
...
(function() {
  ...
  ***REMOVED***;
  ...
  var baseCreate = function(prototype) {
    if (!_.isObject(prototype)) return {***REMOVED***;
  ...
  ***REMOVED***;
  ...
  _.sortBy = function(obj, iteratee, context) {
    ...
    return _.pluck(_.map(obj, function(value, index, list) {
      ...
      ***REMOVED***;
    ***REMOVED***).sort(function(left, right) {
      var a = left.criteria;
    ...
    ***REMOVED***
    ...
    for (var i = 0, length = getLength(array); i < length; i++) {
      ...
      if (isSorted) {
        ...
        seen = computed;
      ***REMOVED*** else if (iteratee) {
        if (!_.contains(seen, computed)) {
          seen.push(computed);
          result.push(value);
        ***REMOVED***
      ***REMOVED*** else if (!_.contains(result, value)) {
        result.push(value);
      ***REMOVED***
    ***REMOVED***
    return result;
  ...
  function createIndexFinder(dir, predicateFind, sortedIndex) {
    return function(array, item, idx) {
      ...
      if (typeof idx == 'number') {
        ...
        ***REMOVED***
      ***REMOVED*** else if (sortedIndex && idx && length) {
  ...
  ***REMOVED***;
  ...
  // `{leading: false***REMOVED***`. To disable execution on the trailing edge, ditto.
  ...
  ***REMOVED***;
  ...
  var hasEnumBug = !{toString: null***REMOVED***.propertyIsEnumerable('toString');
  ...
  ***REMOVED***;
  ...
  _.pick = function(object, oiteratee, context) {
    var result = {***REMOVED***, obj = object, iteratee, keys;
    ...
    ***REMOVED*** else {
      ...
      iteratee = function(value, key, obj) { return key in obj; ***REMOVED***;
      obj = Object(obj);
    ***REMOVED***
    for (var i = 0, length = keys.length; i < length; i++) {
      var key = keys[i];
  ...
  ***REMOVED***;
  ...
  _.clone = function(obj) {
    ...
    return _.isArray(obj) ? obj.slice() : _.extend({***REMOVED***, obj);
  ***REMOVED***;
  ...
  ***REMOVED***;
  ...
  _.noop = function(){***REMOVED***;

  _.property = property;

  // Generates a function for a given object that returns a given property.
  _.propertyOf = function(obj) {
    return obj == null ? function(){***REMOVED*** : function(key) {
      return obj[key];
    ***REMOVED***;
  ***REMOVED***;
  ...
  _.matcher = _.matches = function(attrs) {
    attrs = _.extendOwn({***REMOVED***, attrs);
    return function(obj) {
  ...
  ***REMOVED***;
  ...
  _.template = function(text, settings, oldSettings) {
    ...
    settings = _.defaults({***REMOVED***, settings, _.templateSettings);
    ...
    ***REMOVED***);
    ...
    if (!settings.variable) source = 'with(obj||{***REMOVED***){\n' + source + '***REMOVED***\n';
