...
emgcli import_kegg_modules {GITHUB_WORKSPACE}/client-repo/ci/fixtures/kegg_module_orthology.json
emgcli import_kegg_classes {GITHUB_WORKSPACE}/client-repo/ci/fixtures/kegg_class_orthology.json
emgcli import_cog_descriptions {GITHUB_WORKSPACE}/client-repo/ci/fixtures/cog.csv
