...
describe.skip('Analysis page', function() {
  ...
  context('Quality Control tab', function() {
    ...
    it('Reads length bar chart should be present', function() {
      const series0 = '#reads-length-barchart svg .highcharts-series-0 > rect:nth-child(1)';
      hoverAndValidateTooltip(series0, 'Minimum', 'Minimum:');
      hoverAndValidateTooltip(series0, 'Minimum', '100');
      const series1 = '#reads-length-barchart svg .highcharts-series-0 > rect:nth-child(2)';
      hoverAndValidateTooltip(series1, 'Average', 'Average:');
      hoverAndValidateTooltip(series1, 'Average', '100');
      const series2 = '#reads-length-barchart svg .highcharts-series-0 > rect:nth-child(3)';
    ...
    it('Reads GC bar chart should be present', function() {
      const series0 = '#reads-gc-barchart svg .highcharts-series-0 > rect:nth-child(1)';
      hoverAndValidateTooltip(series0, 'Content', 'GC content: 44.51%');
      const series1 = '#reads-gc-barchart svg .highcharts-series-1 > rect:nth-child(1)';
  ...
  context('Functional tab Interpro (pipeline < 5.0)', function() {
    ...
    it('Should load interpro matches table correctly', function() {
      cy.contains('Total: 2571357 InterPro matches').should('be.visible');
      const interproTable = new ClientSideTableHandler('[data-cy="interpro-table"]', 25, false);
      interproTable.checkLoadedCorrectly(1, 25, 10587, interproMatchCols);
    });
    it('Interpro match pagination should work', function() {
      const interproTable = new GenericTableHandler('[data-cy="interpro-table"]', 25, false);
