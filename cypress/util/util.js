...
export const Util = {
  ...
  changeSubTab(subTabName) {
    cy.get('button.mg-button-as-tab').contains(subTabName).click();
  },
  openAndWait(page, waitFor) {
    Util.openPage(page);
    Util.waitForPageLoad(waitFor);
  },
  openWaitAndChangeTab(page, waitFor, tab) {
