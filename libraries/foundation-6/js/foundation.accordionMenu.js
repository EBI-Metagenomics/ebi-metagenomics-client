    ...
    ***REMOVED***).on('keydown.zf.accordionmenu', function(e){
      ...
      $elements.each(function(i) {
        if ($(this).is($element)) {
          ...
          ***REMOVED*** else if ($prevElement.parents('li').first().children('[data-submenu]:visible').length) { // if previous element has open sub menu
        ...
        ***REMOVED***,
        close: function() {
          if ($target.length && !$target.is(':hidden')) { // close active sub of this item
            _this.up($target);
          ***REMOVED*** else if ($element.parent('[data-submenu]').length) { // close currently open sub
  ...
  down($target) {
    ...
    ***REMOVED***
    ...
    $target.addClass('is-active').attr({'aria-hidden': false***REMOVED***)
      .parent('.is-accordion-submenu-parent').attr({'aria-expanded': true***REMOVED***);
