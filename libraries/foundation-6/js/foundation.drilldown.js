...
class Drilldown {
      ...
      ***REMOVED***
      ...
      if(_this.options.closeOnClick){
        ...
        $body.off('.zf.drilldown').on('click.zf.drilldown', function(e){
          if (e.target === _this.$element[0] || $.contains(_this.$element[0], e.target)) { return; ***REMOVED***
          e.preventDefault();
          _this._hideAll();
  ...
  ***REMOVED***
   ...
   */
  _getMaxDims() {
    var  maxHeight = 0, result = {***REMOVED***, _this = this;
    ...
    ***REMOVED***);
    ...
    if(!this.options.autoHeight) result['min-height'] = `${maxHeight***REMOVED***px`;

    result['max-width'] = `${this.$element[0].getBoundingClientRect().width***REMOVED***px`;
