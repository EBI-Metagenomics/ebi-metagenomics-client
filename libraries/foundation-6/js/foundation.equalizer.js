...
class Equalizer {
  ...
  ***REMOVED***
  ...
  _init() {
    ...
    var $watched = this.$element.find(`[data-equalizer-watch="${eqId***REMOVED***"]`);
  ...
  ***REMOVED***
   ...
   */
  _onPostEqualized(e) {
    if(e.target !== this.$element[0]){ this._reflow(); ***REMOVED***
  ***REMOVED***
  ...
  getHeightsByRow(cb) {
    ...
    ***REMOVED***
    ...
    for (var j = 0, ln = groups.length; j < ln; j++) {
      var heights = $(groups[j]).map(function(){ return this[1]; ***REMOVED***).get();
