    ...
    ***REMOVED***,
    ...
    handleKey: function (event, component, functions) {
      ...
      ***REMOVED*** else {
        ...
        if (Foundation.rtl()) cmds = $.extend({***REMOVED***, commandList.ltr, commandList.rtl);else cmds = $.extend({***REMOVED***, commandList.rtl, commandList.ltr);
      ***REMOVED***
    ...
    ***REMOVED***,
    ...
    trapFocus: function ($element) {
      ...
      $element.on('keydown.zf.trapfocus', function (event) {
        ...
        ***REMOVED*** else if (event.target === $firstFocusable[0] && Foundation.Keyboard.parseKey(event) === 'SHIFT_TAB') {
          event.preventDefault();
          $lastFocusable.focus();
        ***REMOVED***
      ***REMOVED***);
...
(function( $, window, undefined ) {
	...
	$.event.special.swipe = {
		...
		getLocation: function ( event ) {
			...
			if ( event.pageY === 0 && Math.floor( y ) > Math.floor( event.pageY ) ||
				...
				x = x - winPageX;
				y = y - winPageY;
			***REMOVED*** else if ( y < ( event.pageY - winPageY) || x < ( event.pageX - winPageX ) ) {
		...
		***REMOVED***,
		...
		handleSwipe: function( start, stop, thisObject, origTarget ) {
			if ( stop.time - start.time < $.event.special.swipe.durationThreshold &&
				...
				triggerCustomEvent( thisObject, "swipe", $.Event( "swipe", { target: origTarget, swipestart: start, swipestop: stop ***REMOVED***), true );
				triggerCustomEvent( thisObject, direction,$.Event( direction, { target: origTarget, swipestart: start, swipestop: stop ***REMOVED*** ), true );
				return true;
			***REMOVED***
			return false;
	...
	***REMOVED***, function( event, sourceEvent ) {
...
//     bodyObserver.observe(document.body, { attributes: true, childList: true, characterData: false, subtree:true, attributeFilter:["style", "class"]***REMOVED***);
//
//
//     //body callback
...
!function ($) {
  ...
  var AccordionMenu = function () {
    ...
    function AccordionMenu(element, options) {
      ...
      this.$element = element;
      this.options = $.extend({***REMOVED***, AccordionMenu.defaults, this.$element.data(), options);
    ...
    ***REMOVED***, {
      ...
      value: function down($target) {
        ...
        ***REMOVED***
        ...
        $target.addClass('is-active').attr({ 'aria-hidden': false ***REMOVED***).parent('.is-accordion-submenu-parent').attr({ 'aria-expanded': true ***REMOVED***);
...
!function ($) {
  ...
  var Drilldown = function () {
    ...
    function Drilldown(element, options) {
      ...
      this.$element = element;
      this.options = $.extend({***REMOVED***, Drilldown.defaults, this.$element.data(), options);
    ...
    ***REMOVED***, {
      ...
      value: function _scrollTop() {
        ...
        $('html, body').stop(true).animate({ scrollTop: scrollPos ***REMOVED***, _this.options.animationDuration, _this.options.animationEasing, function () {
          /**
  ...
  var Dropdown = function () {
    ...
    ***REMOVED***, {
      ...
      value: function open() {
        ...
        this.$anchor.addClass('hover').attr({ 'aria-expanded': true ***REMOVED***);
        // this.$element/*.show()*/;
        this._setPosition();
        this.$element.addClass('is-open').attr({ 'aria-hidden': false ***REMOVED***);
...
!function ($) {
  ...
  var Equalizer = function () {
    ...
    function Equalizer(element, options) {
      ...
      this.$element = element;
      this.options = $.extend({***REMOVED***, Equalizer.defaults, this.$element.data(), options);
    ...
    ***REMOVED***, {
      ...
      value: function applyHeightByRow(groups) {
        ...
        for (var i = 0, len = groups.length; i < len; i++) {
          ...
          if (groupsILength <= 2) {
            $(groups[i][0][0]).css({ 'height': 'auto' ***REMOVED***);
            continue;
          ***REMOVED***
          /**
          ...
          for (var j = 0, lenJ = groupsILength - 1; j < lenJ; j++) {
            $(groups[i][j][0]).css({ 'height': max ***REMOVED***);
          ***REMOVED***
          /**
...
!function ($) {
  ...
  var Interchange = function () {
    ...
    function Interchange(element, options) {
      ...
      this.$element = element;
      this.options = $.extend({***REMOVED***, Interchange.defaults, options);
      this.rules = [];
      this.currentPath = '';
...
!function ($) {
  ...
  var Magellan = function () {
    ...
    function Magellan(element, options) {
      ...
      this.$element = element;
      this.options = $.extend({***REMOVED***, Magellan.defaults, this.$element.data(), options);
    ...
    ***REMOVED***, {
      ...
      value: function scrollToLoc(loc) {
        ...
        ***REMOVED***
        ...
        $('html, body').stop(true).animate({ scrollTop: scrollPos ***REMOVED***, this.options.animationDuration, this.options.animationEasing, function () {
...
!function ($) {
  ...
  var OffCanvas = function () {
    ...
    function OffCanvas(element, options) {
      ...
      this.$element = element;
      this.options = $.extend({***REMOVED***, OffCanvas.defaults, this.$element.data(), options);
      this.$lastTrigger = $();
      this.$triggers = $();
  ...
  var Orbit = function () {
    ...
    */
    function Orbit(element, options) {
      ...
      this.$element = element;
      this.options = $.extend({***REMOVED***, Orbit.defaults, this.$element.data(), options);
      ...
      value: function _setWrapperHeight(cb) {
        ...
        this.$slides.each(function () {
          ...
          if (_this.$slides.filter('.is-active')[0] !== _this.$slides.eq(counter)[0]) {
            ...
            $(this).css({ 'position': 'relative', 'display': 'none' ***REMOVED***);
          ***REMOVED***
        ...
        if ($newSlide.length) {
          ...
          ***REMOVED***
          ...
          if (this.options.useMUI && !this.$element.is(':hidden')) {
            Foundation.Motion.animateIn($newSlide.addClass('is-active').css({ 'position': 'absolute', 'top': 0 ***REMOVED***), this.options['animInFrom' + dirIn], function () {
            ...
            open: function () {
              if (_this.$element.find(':focus').is(_this.$element.find('[data-close]'))) {
                setTimeout(function () {
                  ...
                  _this.$anchor.focus();
                ***REMOVED***, 1);
              ***REMOVED*** else if ($target.is(_this.focusableElements)) {
...
!function ($) {
  ...
  var Sticky = function () {
    ...
    function Sticky(element, options) {
      ...
      this.$element = element;
      this.options = $.extend({***REMOVED***, Sticky.defaults, this.$element.data(), options);
    ...
    _createClass(Sticky, [{
      ...
      value: function _init() {
        ...
        ***REMOVED***
        ...
        this.$element.addClass(this.options.stickyClass).attr({ 'data-resize': id ***REMOVED***);
    ...
    ***REMOVED***, {
      ...
      ***REMOVED***
       ...
       * @private
       * @param {String***REMOVED*** id - psuedo-random id for unique scroll event listener.
       */
    ...
    ***REMOVED***, {
      ...
      value: function destroy() {
        ...
        this.$element.removeClass(this.options.stickyClass + ' is-anchored is-at-top').css({
          ...
          bottom: '',
          'max-width': ''
        ***REMOVED***).off('resizeme.zf.trigger');
        if (this.$anchor && this.$anchor.length) {
  ...
  var Tabs = function () {
          ...
          ***REMOVED***);
          ...
          if (isActive && _this.options.autoFocus) {
            $(window).load(function () {
              $('html, body').animate({ scrollTop: $elem.offset().top ***REMOVED***, _this.options.deepLinkSmudgeDelay, function () {
                $link.focus();
              ***REMOVED***);
            ***REMOVED***);
          ***REMOVED***
          ...
          if (anchor.length) {
            ...
            if ($link.length) {
              ...
              if (_this2.options.deepLinkSmudge) {
                ...
                $('html, body').animate({ scrollTop: offset.top ***REMOVED***, _this2.options.deepLinkSmudgeDelay);
              ***REMOVED***
    ...
    ***REMOVED***, {
      ...
      value: function _openTab($target) {
        ...
        $targetContent.addClass('' + this.options.panelActiveClass).attr({ 'aria-hidden': 'false' ***REMOVED***);
      ***REMOVED***
    ...
    ***REMOVED***, {
      ...
      value: function _collapseTab($target) {
        var $target_anchor = $target.removeClass('' + this.options.linkActiveClass).find('[role="tab"]').attr({ 'aria-selected': 'false' ***REMOVED***);

        $('#' + $target_anchor.attr('aria-controls')).removeClass('' + this.options.panelActiveClass).attr({ 'aria-hidden': 'true' ***REMOVED***);
      ***REMOVED***
...
!function ($) {
  ...
  var ResponsiveAccordionTabs = function () {
    ...
    function ResponsiveAccordionTabs(element, options) {
      ...
      this.$element = $(element);
      this.options = $.extend({***REMOVED***, this.$element.data(), options);
        ...
        ***REMOVED***;
        ...
        if (toSet === 'accordion') {
          $panels.each(function (key, value) {
            $(value).appendTo($liHeads.get(key)).addClass('accordion-content').attr('data-tab-content', '').removeClass('is-active').css({ height: '' ***REMOVED***);
