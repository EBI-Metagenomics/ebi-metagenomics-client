...
class OffCanvas {
  ...
  ***REMOVED***
  ...
  _init() {
    ...
    this.$element.addClass(`is-transition-${this.options.transition***REMOVED***`);
  ...
  ***REMOVED***
  ...
  reveal(isRevealed) {
    ...
    if (isRevealed) {
      ...
      if ($closer.length) { $closer.hide(); ***REMOVED***
    ***REMOVED*** else {
  ...
  ***REMOVED***
   ...
   */
  open(event, trigger) {
    if (this.$element.hasClass('is-open') || this.isRevealed) { return; ***REMOVED***
    var _this = this;
