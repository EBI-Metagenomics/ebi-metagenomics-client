...
class Sticky {
  ...
  _init() {
    ...
    ***REMOVED***
    ...
    if (this.options.anchor !== '') {
        $('#' + _this.options.anchor).attr({ 'data-mutate': id ***REMOVED***);
    ***REMOVED***
  ...
  ***REMOVED***
  ...
  _events(id) {
    var _this = this,
        scrollListener = this.scrollListener = `scroll.zf.${id***REMOVED***`;
    if (this.isOn) { return; ***REMOVED***
    if (this.canStick) {
      this.isOn = true;
  ...
  ***REMOVED***
  ...
  _calc(checkSizes, scroll) {
    if (checkSizes) { this._setSizes(); ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (!scroll) { scroll = window.pageYOffset; ***REMOVED***
  ...
  ***REMOVED***
  ...
  _setSticky() {
    ...
    css[mrgn] = `${this.options[mrgn]***REMOVED***em`;
    css[stickTo] = 0;
    css[notStuckTo] = 'auto';
    this.isStuck = true;
    this.$element.removeClass(`is-anchored is-at-${notStuckTo***REMOVED***`)
                 .addClass(`is-stuck is-at-${stickTo***REMOVED***`)
                 .css(css)
                 /**
                  ...
                  */
                 .trigger(`sticky.zf.stuckto:${stickTo***REMOVED***`);
  ...
  ***REMOVED***
  ...
  _removeSticky(isTop) {
    ...
    ***REMOVED***
    ...
    this.isStuck = false;
    this.$element.removeClass(`is-stuck is-at-${stickTo***REMOVED***`)
                 .addClass(`is-anchored is-at-${topOrBottom***REMOVED***`)
                 .css(css)
                 /**
                  ...
                  */
                 .trigger(`sticky.zf.unstuckfrom:${topOrBottom***REMOVED***`);
  ***REMOVED***
  ...
  _setSizes(cb) {
    ...
    ***REMOVED***
    ...
    this.$element.css({
      'max-width': `${newElemWidth - pdngl - pdngr***REMOVED***px`
    ***REMOVED***);
  ...
  ***REMOVED***
  ...
  destroy() {
    ...
    this.$element.removeClass(`${this.options.stickyClass***REMOVED*** is-anchored is-at-top`)
                 .css({
                   height: '',
                   top: '',
                   bottom: '',
