...
;(function($){
	...
	regex = {
		mdy        : /(\d{1,2***REMOVED***[-\s]\d{1,2***REMOVED***[-\s]\d{4***REMOVED***(\s+\d{1,2***REMOVED***:\d{2***REMOVED***(:\d{2***REMOVED***)?(\s+[AP]M)?)?)/gi,

		dmy        : /(\d{1,2***REMOVED***[-\s]\d{1,2***REMOVED***[-\s]\d{4***REMOVED***(\s+\d{1,2***REMOVED***:\d{2***REMOVED***(:\d{2***REMOVED***)?(\s+[AP]M)?)?)/gi,
		dmyreplace : /(\d{1,2***REMOVED***)[-\s](\d{1,2***REMOVED***)[-\s](\d{4***REMOVED***)/,

		ymd        : /(\d{4***REMOVED***[-\s]\d{1,2***REMOVED***[-\s]\d{1,2***REMOVED***(\s+\d{1,2***REMOVED***:\d{2***REMOVED***(:\d{2***REMOVED***)?(\s+[AP]M)?)?)/gi,
		ymdreplace : /(\d{4***REMOVED***)[-\s](\d{1,2***REMOVED***)[-\s](\d{1,2***REMOVED***)/,

		// extract out date format (dd MMM yyyy hms) e.g. 13 March 2016 12:55 PM
		overall_dMMMyyyy : /(\d{1,2***REMOVED***\s+\w+\s+\d{4***REMOVED***(\s+\d{1,2***REMOVED***:\d{2***REMOVED***(:\d{2***REMOVED***)?(\s\w+)?)?)/g,
		matches_dMMMyyyy : /(\d{1,2***REMOVED***)\s+(\w+)\s+(\d{4***REMOVED***)/
