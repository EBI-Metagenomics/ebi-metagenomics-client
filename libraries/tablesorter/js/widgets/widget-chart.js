		...
		getHeaders: function(c, wo) {
			...
			$.each(chart_cols, function(k, col) {
				...
				***REMOVED***
				...
				chart_series.push( { name: text, data: [] ***REMOVED*** );
				chart_dataset.push( { seriesname: text, data: [] ***REMOVED*** );
			***REMOVED***);
		***REMOVED***,
			...
			$.each(rows, function(i, rowVal) {
				...
				$.each(rowVal, function(indx, cellValue) {
					...
					if (indx === wo.chart_labelCol) {
						...
						chart_category.push({ 'label': cellValue ***REMOVED***);
						return true;
					***REMOVED***
					value = false;
					if ( wo.chart_useSelector && ts.hasWidget( c.table, 'columnSelector' ) && !c.selector.auto ) {
					...
					***REMOVED***
					...
					if (value !== false) {
						...
						***REMOVED*** else {
							...
							chart_dataset[objIndex].data.push( { value : tempVal ***REMOVED*** );
						***REMOVED***
						objIndex++;
					***REMOVED***
				***REMOVED***);
