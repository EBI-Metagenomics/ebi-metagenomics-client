...
;(function($){
	...
	ts.filterFormatter = ts.filterFormatter || {***REMOVED***;
		...
		***REMOVED***,
		...
		updateOptions = function(){
			...
			$.each(arry, function(i, v){
				// getOptionSource returns { parsed: "value", text: "value" ***REMOVED*** in v2.24.4
				data.push({ id: '' + v.parsed, text: v.text ***REMOVED***);
			***REMOVED***);
			o.data = data;
		***REMOVED***;
