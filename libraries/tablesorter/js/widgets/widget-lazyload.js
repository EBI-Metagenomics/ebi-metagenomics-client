...
(function($, window, document, undefined) {
			...
			elements.each(function() {
				...
				***REMOVED***
				if ($.abovethetop(this, settings) || $.leftofbegin(this, settings)) {
					/* Nothing. */
				***REMOVED*** else if (!$.belowthefold(this, settings) && !$.rightoffold(this, settings)) {
					$this.trigger("appear");
	...
	***REMOVED***;
	...
	/* Use as  $.belowthefold(element, {threshold : 100, container : window***REMOVED***) */
	...
	***REMOVED***;
	...
	$.extend($.expr[":"], {
		"below-the-fold" : function(a) { return $.belowthefold(a, {threshold : 0***REMOVED***); ***REMOVED***,
		"above-the-top"  : function(a) { return !$.belowthefold(a, {threshold : 0***REMOVED***); ***REMOVED***,
		"right-of-screen": function(a) { return $.rightoffold(a, {threshold : 0***REMOVED***); ***REMOVED***,
		"left-of-screen" : function(a) { return !$.rightoffold(a, {threshold : 0***REMOVED***); ***REMOVED***,
		"in-viewport"    : function(a) { return $.inviewport(a, {threshold : 0***REMOVED***); ***REMOVED***,
		/* Maintain BC for couple of versions. */
		"above-the-fold" : function(a) { return !$.belowthefold(a, {threshold : 0***REMOVED***); ***REMOVED***,
		"right-of-fold"  : function(a) { return $.rightoffold(a, {threshold : 0***REMOVED***); ***REMOVED***,
		"left-of-fold"   : function(a) { return !$.rightoffold(a, {threshold : 0***REMOVED***); ***REMOVED***
	***REMOVED***);
