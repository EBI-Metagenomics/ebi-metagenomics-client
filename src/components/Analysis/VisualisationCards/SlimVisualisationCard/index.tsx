        ...
        <div className="slim-card-header">
          ...
          >
            <Tooltip content="Download">
              {}
              {(() => {
                // Helper handlers to avoid repetition and satisfy a11y (onFocus/onBlur)
                const activate = (
                  e: React.SyntheticEvent<HTMLButtonElement>
                ) => {
                  const t = e.currentTarget;
                  t.style.backgroundColor = fileTypeColors.bg;
                  t.style.borderColor = fileTypeColors.color;
                  t.style.transform = 'translateY(-1px)';
                  t.style.boxShadow = `0 3px 6px ${fileTypeColors.color}25`;
                };
                const deactivate = (
                  e: React.SyntheticEvent<HTMLButtonElement>
                ) => {
                  const t = e.currentTarget;
                  t.style.backgroundColor = fileTypeColors.bg;
                  t.style.borderColor = `${fileTypeColors.color}40`;
            ...
            <Tooltip content="Copy link">
              ...
              {(() => {
                const activate = (
                  ...
                  const t = e.currentTarget;
                  t.style.backgroundColor = showCopiedMessage
                    ? '#d4edda'
                    : '#edf4f7';
                  t.style.borderColor = showCopiedMessage
                    ? '#28a745'
                    : '#3B6FB6';
                  t.style.transform = 'translateY(-1px)';
                  t.style.boxShadow = showCopiedMessage
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      height: '40px',
                      borderRadius: '50%',
                      backgroundColor: showCopiedMessage
                        ? '#edf8ed'
                        : '#f8f8f8',
