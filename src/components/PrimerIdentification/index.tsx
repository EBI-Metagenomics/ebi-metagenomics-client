  ...
  return (
    <>
      <div className="legend-container">
        <button
          className="legend-header-button"
          onClick={() => setIsLegendOpen(!isLegendOpen)}
          aria-expanded={isLegendOpen}
        >
          <div className="legend-title-area">
        ...
        <div
          className={`legend-content-wrapper ${isLegendOpen ? 'is-open' : ''}`}
        >
          <div className="legend-content">
            ...
            <div className="legend-section full-width">
              <h6 className="legend-section-title">
              ...
              <div className="legend-items strategy-items">
                ...
                <div className="strategy-item">
                  ...
                  <p className="strategy-description">
                    ...
                    sequence data when standard primers are not found. This
                    method attempts to detect primer sequences at the beginning
                    and end of reads without prior knowledge.
                  </p>
                </div>
              </div>
            </div>
