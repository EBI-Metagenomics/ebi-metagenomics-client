    ...
    <section className="vf-content">
      ...
      <section className="vf-card-container vf-card-container__col-4">
        <div className="vf-card-container__inner">
          ...
          {
            !!genomeData.attributes['other-stats'] && Object.entries(genomeData.attributes['other-stats'] as object).map(([key, value]) => (
              <article className="vf-card vf-card--brand vf-card--bordered" key={key}>
                <div className="vf-card__content | vf-stack vf-stack--200">
                  <h3 className="vf-card__heading">
                    {value}
                  </h3>
