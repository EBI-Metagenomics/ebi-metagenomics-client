    ...
    return (
      <div className="vf-meta__details">
        <p>
          ...
          &nbsp;
          {`${prefix} a region beyond an EEZ. 
          While this means there are no national ABS obligations under individual countries' jurisdiction, 
          benefit-sharing obligations may still apply for the use of 
