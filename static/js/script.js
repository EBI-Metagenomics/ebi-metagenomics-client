...
function ebiFrameworkPopulateBlackBar() {
    try {
        ...
        barContents.innerHTML = '<nav class="row">'+
            ...
            '<li class="home-mobile"><a href="https://wwwdev.ebi.ac.uk"></a></li>'+
            ...
            // '</div>'+
            '</li>'+
            '<li class="what about"><a href="https://wwwdev.ebi.ac.uk/about">About us</a></li>'+
            '<li class="what training"><a href="https://wwwdev.ebi.ac.uk/training">Training</a></li>'+
            '<li class="what research"><a href="https://wwwdev.ebi.ac.uk/research">Research</a></li>'+
            '<li class="what services"><a href="https://wwwdev.ebi.ac.uk/services">Services</a></li>'+
            '<li class="where ebi"><a href="https://wwwdev.ebi.ac.uk">EMBL-EBI</a></li>'+
...
function ebiFrameworkInsertEMBLdropdown() {
    try {
        ...
        dropdownDiv.innerHTML = '<nav id="embl-bar" class="embl-bar global-masthead-interactive-banner">'+
            ...
            '<div class="column">'+
            '<h5 class="inline"><a href="https://wwwdev.ebi.ac.uk/">Hinxton</a></h5>'+
...
function ebiFrameworkUpdateFoot() {
    var html = '<div class="columns small-12">' +
        '<h4 class="inline-block"><a href="https://wwwdev.ebi.ac.uk" class="no-underline" title="EMBL-EBI">EMBL-EBI</a></h4>' +
        ...
        '<div class="column">' +
        '<h5 class="services"><a class="services-color" href="https://wwwdev.ebi.ac.uk/services">Services</a></h5><ul>' + ' <li class="first"><a href="https://wwwdev.ebi.ac.uk/services">By topic</a></li> ' + ' <li><a href="https://wwwdev.ebi.ac.uk/services/all">By name (A-Z)</a></li> ' + ' <li class="last"><a href="https://wwwdev.ebi.ac.uk/support">Help &amp; Support</a></li> ' + '</ul></div>' +
        '<div class="column">' +
        '<h5 class="research"><a class="research-color" href="https://wwwdev.ebi.ac.uk/research">Research</a></h5><ul>' + ' <li><a href="https://wwwdev.ebi.ac.uk/research/publications">Publications</a></li> ' + ' <li><a href="https://wwwdev.ebi.ac.uk/research/groups">Research groups</a></li> ' + ' <li class="last"><a href="https://wwwdev.ebi.ac.uk/research/postdocs">Postdocs</a> &amp; <a href="https://wwwdev.ebi.ac.uk/research/eipp">PhDs</a></li> ' +
        '</ul></div>' +
        '<div class="column"> ' +
        '<h5 class="training"><a class="training-color" href="https://wwwdev.ebi.ac.uk/training">Training</a></h5><ul>' + ' <li><a href="https://wwwdev.ebi.ac.uk/training/handson">Train at EBI</a></li> ' + ' <li><a href="https://wwwdev.ebi.ac.uk/training/roadshow">Train outside EBI</a></li> ' + ' <li><a href="https://wwwdev.ebi.ac.uk/training/online">Train online</a></li> ' + ' <li class="last"><a href="https://wwwdev.ebi.ac.uk/training/contact-us">Contact organisers</a></li> ' +
        '</ul></div> ' +
        '<div class="column"> ' +
        '<h5 class="industry"><a class="industry-color" href="https://wwwdev.ebi.ac.uk/industry">Industry</a></h5><ul>' + ' <li><a href="https://wwwdev.ebi.ac.uk/industry/private">Members Area</a></li> ' + ' <li><a href="https://wwwdev.ebi.ac.uk/industry/workshops">Workshops</a></li> ' + ' <li><a href="https://wwwdev.ebi.ac.uk/industry/sme-forum"><abbr title="Small Medium Enterprise">SME</abbr> Forum</a></li> ' + ' <li class="last"><a href="https://wwwdev.ebi.ac.uk/industry/contact">Contact Industry programme</a></li> ' + '</ul></div> ' +
        '<div class="column"> ' +
        '<h5 class="about"><a class="ebi-color" href="https://wwwdev.ebi.ac.uk/about">About</a></h5><ul> ' + ' <li><a href="https://wwwdev.ebi.ac.uk/about/contact">Contact us</a>' + '<li><a href="https://wwwdev.ebi.ac.uk/about/events">Events</a></li> ' + ' <li><a href="https://wwwdev.ebi.ac.uk/about/jobs" title="Jobs, postdocs, PhDs...">Jobs</a></li> ' + ' <li class="first"><a href="https://wwwdev.ebi.ac.uk/about/news">News</a></li> ' + ' <li><a href="https://wwwdev.ebi.ac.uk/about/people">People &amp; groups</a></li> ' +
        '</ul></div>' +
        '</div>';
...
function ebiFrameworkCookieBanner() {
    ...
    function createBanner() {
        ...
        wrapper.innerHTML = "" +
            ...
            "To find out more, see our <a href='//wwwdev.ebi.ac.uk/about/terms-of-use'>Terms of Use</a>.</span>" +
            "<div id='cookie-dismiss'><button class='close-button' style='top: 0.3rem; color:#fff;' aria-label='Close alert' type='button'><span aria-hidden='true'>&times;</span></button></div>" +
            "";
