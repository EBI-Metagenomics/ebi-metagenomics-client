...
module.exports = {
  entry: {
    ...
    superstudy: "src/js/modules/superstudy.js",
    study: "src/js/modules/study.js",
    browse: "src/js/modules/browse.js",
    sample: "src/js/modules/sample.js",
    run: "src/js/modules/run.js",
    assembly: "src/js/modules/assembly.js",
    analysis: "src/js/modules/analysis.js",
    ...
    publication: "src/js/modules/publication.js",
    genomeCatalogue: "src/js/modules/genome-catalogue.js",
    genome: "src/js/modules/genome.js",
  },
  plugins: [
  ...
  output: {
    ...
    path: __dirname + "/dist" + process.env.DEPLOYMENT_SUBFOLDER,
